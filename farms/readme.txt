...
farmId (int) Required
startDateTime(date time) Required. Format(MM/dd/yyyy-HH:mm:ss) e.g. 02/25/2020-16:20:20
...
Response:-
{
  "1001": {
    "farmId": 1001,
    "status": "Requested",
    "startDateTime": "25-Feb-2020 09:53:20",
    "duration": 1
  },
  "1002": {
    "farmId": 1002,
    "status": "Requested",
    "startDateTime": "25-Feb-2020 10:00:00",
    "duration": 1
  }
}
...
Date validation:-
1.Date format should be(dd-MMM-yyyy HH:mm:ss) e.g. 20-Feb-2020 16:20:20, where time should be in 24 hours format
